...
let g:colors_name = "nightshimmer-mod"
...
highlight Normal        gui=None guibg=#000010 guifg=honeydew2
...
highlight WildMenu      gui=bold guibg=LightGreen guifg=Black
...
highlight Statement     gui=NONE guifg=Green
    highlight Conditional gui=bold guifg=SeaGreen guibg=bg
    highlight Repeat gui=None guifg=SeaGreen guibg=bg
    "hi Label gui=None guifg=LightGreen guibg=bg
    highlight Operator gui=bold guifg=Green guibg=bg
    highlight Keyword gui=bold guifg=Green guibg=bg
...
highlight Underlined gui=underline guifg=honeydew4 guibg=black
